...
public class RepairTypeGeneratorF {
    ...
    private final ReasonerFacadeF reasonerWithTBox, reasonerWithoutTBox;

    public RepairTypeGeneratorF(ReasonerFacadeF reasonerWithTBox, ReasonerFacadeF reasonerWithoutTBox) {
    ...
    private Set<OWLClassExpression> getSubsumptionMaximalOWLClassExpressions(Set<OWLClassExpression> owlClassExpressions) {
        return UtilF.getMaximalElements(owlClassExpressions, reasonerWithoutTBox::subsumedBy);
    }
    ...
    private Set<Set<OWLClassExpression>> getCoverMinimalOWLClassExpressionSets(Set<Set<OWLClassExpression>> owlClassExpressionSets) {
        return UtilF.getMaximalElements(owlClassExpressionSets, (x, y) -> reasonerWithoutTBox.isCovered(y, x));
    }
