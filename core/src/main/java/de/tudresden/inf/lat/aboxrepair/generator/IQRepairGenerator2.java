...
//                    .filter(owlClassExpression -> !FreshNameProducer.isFreshOWLClass(owlClassExpression))
            ...
            ontology.objectPropertyAssertionAxioms(subject.getIndividualInTheSaturation())
                    .forEach(axiom -> { typeHandler.findCoveringRepairTypes(
                            RepairType.empty(),
                            computeSuccessorSet(subject.getRepairType(),
                            ...
                            .forEach(repairType -> {
                                ...
                                repair.add(OWLManager.getOWLDataFactory().getOWLObjectPropertyAssertionAxiom(
                                    axiom.getProperty(),
